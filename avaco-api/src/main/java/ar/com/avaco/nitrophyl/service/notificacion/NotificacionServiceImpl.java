...
public class NotificacionServiceImpl implements NotificacionService {
	...
	@Value("Nitrophyl - Restablecimiento de contrasea")
	...
	@Value("Nitrophyl - Usuario Habiliatdo!")
	...
	public void notificarInicioServer() {
		mailSenderSMTPService.sendMail(from, supportMail, "Inicio Server Tomcat",
				"Se inicio el server. " + DateUtils.toString(new Date(), DateUtils.dd_MM_yy_HH_mm), null);

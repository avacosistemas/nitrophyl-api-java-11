 ...
 * @author avaco
 */
public abstract class AbstractAuditableDTORestController<RDTO extends DTOAuditableEntity<ID>, ID extends Serializable, T extends CRUDAuditableEPService<ID,RDTO>> extends AbstractRestBaseController {	

	private static final Logger LOGGER = LogManager.getLogger(AbstractAuditableDTORestController.class);

...
public class EsquemaRestController extends AbstractAuditableDTORestController<EsquemaDTO, Long, EsquemaEPService> {
	...
	@Override
	@RequestMapping(value = "/esquema/{id}", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<JSONResponse> update(@PathVariable Long id, @RequestBody EsquemaDTO dto)
			throws BusinessException {
		return super.update(id, dto);
	}

	@Override
	@RequestMapping(value = "/esquema/{id}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<JSONResponse> delete(@PathVariable Long id) throws BusinessException {
		return super.delete(id);
	}

	@Resource(name = "esquemaEPService")
	public void setService(EsquemaEPService esquemaEPService) {
		super.service = esquemaEPService;
	}

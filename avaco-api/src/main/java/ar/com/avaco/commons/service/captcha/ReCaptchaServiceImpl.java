    ...
    public boolean verifyRecaptcha(String response) {
        ...
        try {
            ...
            if (!googleResponse.isSuccess()) {
                ...
                reCaptchaOk = false;
                //throw new ReCaptchaInvalidException("reCaptcha no se valid con xito");
            }
        } catch (RestClientException rce) {
        	reCaptchaOk = false;
        	//throw new ReCaptchaUnavailableException("Registracion no disponible en este momento. Por favor, intntelo de nuevo ms tarde.", rce);
        }
